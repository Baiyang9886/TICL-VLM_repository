...
class CrossAttention(nn.Module):
    def __init__(self, device=None, N=1, d_model=768, d_ff=1024, h=4, dropout=0.2):
    ...
    def forward(self, img_feature, task_feature):
        ...
        img_feature = img_feature.reshape(-1, 1024).type(self.dtype)
        img_feature = img_feature @ self.proj
        img_feature = img_feature.reshape(-1, 257, 768)
